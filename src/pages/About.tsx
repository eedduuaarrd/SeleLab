...
const desc =
  'Què és SeleLab: pràctica interactiva per a la selectivitat (PAU) amb preguntes dels models oficials i banc propi.'

export function About() {
  return (
    <>
      <SeoHead title="Sobre SeleLab" description={desc} path="/sobre" />
